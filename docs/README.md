...
| [Wordbank section behavior](./behavior/wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Complete variations uses one Gemini resolution call, keeps same-spelling morphology slots, and omits redundant verb gloss translations (2026-05-22) | Shared |
