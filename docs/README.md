...
| [Wordbank section behavior](./behavior/wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Categories use concise English semantic labels, expanded starter catalog, and post-verification follow-up classification (2026-05-23) | Shared |
