...
| [Sidebar search behavior](./behavior/sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*`, `backend/app/services/use_cases/wordbank/collaborators/*` | Wrong-mode search suggestion uses non-blocking opposite-mode probes and DTC mode checks (2026-05-28) | Shared |
