...
| [Sidebar search behavior](./behavior/sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*`, `backend/app/services/use_cases/wordbank/collaborators/*` | Search collapses indistinguishable COR duplicates, allows core short words, tightens English-to-COR filtering, and blocks unsafe mixed-language sentence previews (2026-05-25) | Shared |
