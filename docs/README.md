...
| --- | --- | --- | --- | --- |
| [App shell behavior](./behavior/app-shell-behavior.md) | Frontend engineers, maintainers | `frontend/src/App.tsx`, `frontend/src/app/layout/*`, `frontend/src/app/chrome/*`, `frontend/src/app/auth/*` | Rounded, clipped application inset around the structural notebook sheet (2026-07-19) | Frontend |
...
| [Wordbank section behavior](./behavior/wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Layered index stock with Danish-only card faces and translation previews (2026-07-19) | Shared |
