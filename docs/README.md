...
| [Sidebar search behavior](./behavior/sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*`, `backend/app/services/use_cases/wordbank/collaborators/*` | Search language mode toggle gates Danish vs English lookup flows and DTC mode checks (2026-05-26) | Shared |
