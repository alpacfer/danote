...
| [Wordbank section behavior](./wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Related words now normalize verb translations to infinitive English and expose reverse compound-host links on component pages (2026-03-22) | Shared |
