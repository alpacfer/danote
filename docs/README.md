...
| [Wordbank section behavior](./wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Surface-form verification now suppresses translation-only Gemini noise and blocks surface `fix_translation` apply (2026-03-22) | Shared |
