...
| --- | --- | --- | --- | --- |
| [App shell behavior](./behavior/app-shell-behavior.md) | Frontend engineers, maintainers | `frontend/src/App.tsx`, `frontend/src/app/layout/*`, `frontend/src/app/chrome/*`, `frontend/src/app/auth/*` | Structural 8/32 notebook sheet and canonical page scrolling (2026-07-17) | Frontend |
...
| [Wordbank section behavior](./behavior/wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Material collection tiles/decks and signature word-page composition (2026-07-17) | Shared |
