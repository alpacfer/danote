...
| --- | --- | --- | --- | --- |
| [App shell behavior](./app-shell-behavior.md) | Frontend engineers, maintainers | `frontend/src/App.tsx`, `frontend/src/app/layout/section-content.tsx`, `frontend/src/app/chrome/*` | Off-page word verification notification tracking update (2026-03-14) | Frontend |
...
| [Sidebar search behavior](./sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*` | COR gloss-vs-translation save semantics update (2026-03-14) | Frontend |
| [Wordbank section behavior](./wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Shared whole-word Gemini categorization context for initial verify and manual rethink (2026-03-14) | Shared |
