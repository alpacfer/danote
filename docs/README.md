...
| [Sidebar search behavior](./behavior/sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*`, `backend/app/services/use_cases/wordbank/collaborators/*` | Saved/open markers are scoped to matching POS/COR lemma identity and search display matches saved word-card display for same-label homographs like `nok` (2026-05-24) | Shared |
