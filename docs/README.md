...
| --- | --- | --- | --- | --- |
| [App shell behavior](./behavior/app-shell-behavior.md) | Frontend engineers, maintainers | `frontend/src/App.tsx`, `frontend/src/app/layout/*`, `frontend/src/app/chrome/*`, `frontend/src/app/auth/*` | Scoped Wordbank dot-grid surface on the structural 8/32 notebook sheet (2026-07-18) | Frontend |
...
| [Wordbank section behavior](./behavior/wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Danish card catalogue, alphabet navigation, and compact reference drawer (2026-07-18) | Shared |
