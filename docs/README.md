...
| [Sidebar search behavior](./sidebar-search-behavior.md) | Frontend engineers, product QA | `frontend/src/app/chrome/sidebar/*`, `frontend/src/app/hooks/sidebar/*` | Checkpoint 18 baseline and docs smoke alignment (2026-03-06) | Frontend |
| [Wordbank section behavior](./wordbank-section-behavior.md) | Frontend engineers, backend integrators | `frontend/src/app/sections/wordbank/*`, `backend/app/api/routes/wordbank.py` | Checkpoint 18 baseline and docs smoke alignment (2026-03-06) | Shared |
