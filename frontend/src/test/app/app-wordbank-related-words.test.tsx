...
describe("App wordbank related words", () => {
  it("renderer-only: renders the Composition section after meaning cards and polls queued related words until they are ready", async () => {
    ...
    await waitFor(() => {
      ...
      const compositionCard = compositionSection?.querySelector("[data-material='related']")
      expect(compositionCard).toHaveAttribute("data-paper-stock")
      expect(compositionCard).toHaveAttribute("data-material-tone", "plum")
