...
import { buildAppSectionPropsParams } from "@/app/hooks/app/controller/build-app-section-props-params"
...
import { useAppSectionProps } from "@/app/hooks/app/use-app-section-props"
...
export function useAppController() {
  ...
  const sectionProps = useAppSectionProps(
    buildAppSectionPropsParams({
      playgroundContext: {
        autosaveStatus: notesPersistence.autosaveStatus,
