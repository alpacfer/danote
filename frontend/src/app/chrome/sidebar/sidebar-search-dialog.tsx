...
export function SidebarSearchDialog({
  ...
  return (
    <CommandDialog
      ...
      commandClassName="max-md:flex-col-reverse max-md:rounded-none max-md:rounded-t-xl max-md:pb-[env(safe-area-inset-bottom)] max-md:[&_[cmdk-group-heading]]:text-sm max-md:[&_[data-slot=command-input-wrapper]]:ml-4 max-md:[&_[data-slot=command-input-wrapper]]:mr-0 max-md:[&_[data-slot=command-input-wrapper]]:mt-4 max-md:[&_[data-slot=command-input-wrapper]]:mb-3 max-md:[&_[data-slot=command-input-wrapper]]:min-h-12 max-md:[&_[data-slot=command-input-wrapper]]:shrink-0 max-md:[&_[data-slot=command-input-wrapper]>svg]:mt-0 max-md:[&_[data-slot=command-input-wrapper]>svg]:self-center max-md:[&_[data-slot=command-input-suffix]]:inset-y-0 max-md:[&_[data-slot=command-input-suffix]]:items-center max-md:[&_[data-slot=command-input-suffix]]:pt-0 max-md:[&_[data-slot=command-input-wrapper]_svg]:h-5 max-md:[&_[data-slot=command-input-wrapper]_svg]:w-5 max-md:[&_[data-slot=command-input]]:!h-auto max-md:[&_[data-slot=command-input]]:text-base max-md:[&_[cmdk-item]]:py-3 max-md:[&_[cmdk-item]]:text-base max-md:[&_[cmdk-item]_svg]:h-5 max-md:[&_[cmdk-item]_svg]:w-5 max-md:[&_[data-slot=command-list]]:max-h-[70dvh] max-md:[&_[data-slot=command-list]]:min-h-0 max-md:[&_[data-slot=command-list]]:flex-initial max-md:[&_[data-slot=command-list]]:pt-3 max-md:[&_[data-slot=command-list]]:pb-2"
