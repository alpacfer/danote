...
export const ENGLISH_SEARCH_PHRASES = SEARCH_PHRASES.filter((phrase) => phrase.includes("English"))
export const DANISH_SEARCH_PHRASES = SEARCH_PHRASES.filter((phrase) => !phrase.includes("English"))
